    ...
    <div class="flex h-screen">
        ...
        <section class="w-1/2 flex items-center justify-center p-4">
            <div class="w-full max-h-[80vh] flex items-center justify-center appear-zoom">
                {!! file_get_contents(public_path('mapa_lluvias.svg')) !!}
            </div>
        </section>

        <!-- CONTENIDO DINÁMICO -->
        <section class="w-1/2 flex flex-col justify-center p-6 lg:p-10">
            <h1 class="text-2xl lg:text-4xl font-bold text-black">{{ __('app.zonas_climaticas_titulo') }}</h1>
            ...
            <div class="text-sm lg:text-base space-y-4 text-gray-700 leading-relaxed appear-content">
                    ...
                    <p> {{ __('app.zonas_climaticas_desc') }} <p>
