...
<div class="flex justify-between">
            ...
            <div class="space-y-[10px]">
                <div class="flex items-center gap-[10px] ">
                   <img
                    ...
                    class="h-[18px] w-auto transition {{ request()->route('year') == 1932 ? 'opacity-100' : 'opacity-50' }}" alt="">
                ...
                <div class="flex items-center gap-[10px] ">
                    ...
                    class="h-[18px] w-auto transition {{ request()->route('year') == 1933 ? 'opacity-100' : 'opacity-50' }}" alt="">
                     <a href="{{ route('guerra.year', [
                        'year' => 1933,
                        'lang' => $lang
                    ]) }}"
            ...
            <div class="space-y-[10px] text-center">
                <div class="flex justify-end items-center gap-[10px] ">
                    <img src="{{ asset('images/lineas.png') }}"
                    class="h-[18px] w-auto transition {{ request()->route('year') == 1934 ? 'opacity-100' : 'opacity-50' }}" alt="">
                    <a href="{{ route('guerra.year', [
                        'year' => 1934,
                        'lang' => $lang
                    ]) }}"
                ...
                <div class="flex justify-end items-center gap-[10px] ">
                    <img src="{{ asset('images/lineas.png') }}"
                    class="h-[18px] w-auto transition {{ request()->route('year') == 1935 ? 'opacity-100' : 'opacity-50' }}"alt="">
                    <a href="{{ route('guerra.year', [
                        'year' => 1935,
                        'lang' => $lang
                    ]) }}"
            ...
            <div class="space-y-[10px] text-left">
                <div class="flex justify-end items-center gap-[10px] ">
                    ...
                    class="h-[25px] w-auto transition {{request('section') =='antecedentes' ? 'opacity-100' : 'opacity-50'}}"alt="">
                    <a href="{{ route('home', [
